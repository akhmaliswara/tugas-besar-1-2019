<?php
	...
	$general = $conn->query("
		...
		film.id_film = film_schedule.id_film AND film_schedule.id_schedule = transaction.id_schedule 
		AND film_schedule.id_schedule = schedule_time.id_schedule AND transaction.username = user.username AND user.email = '".$login_username."'");
	$local_time = getdate();
